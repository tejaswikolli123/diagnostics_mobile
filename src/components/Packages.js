...
const Packages = () => {
  ...
  return (
    <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
        ...
        {cards.map((card, index) => (
          <Card variant="outlined" key={index} sx={{ minWidth: 350, maxWidth: 400, height: '350px', flexShrink: 0 }}>
            ...
            <CardContent sx={{ height: '120px' }}>
              <Typography variant="body1" sx={{ fontSize: '15px', paddingTop: '10px', paddingBottom: '10px', display: 'flex', flexDirection: 'row' }}>
                <BloodtypeIcon sx={{ padding: '0 10px' }} />
                {card.detail1}
              </Typography>
              <Typography variant="body1" sx={{ fontSize: '15px', paddingTop: '10px', paddingBottom: '10px', display: 'flex', flexDirection: 'row' }}>
                <ReportIcon sx={{ padding: '0 10px' }} />
                {card.detail2}
              </Typography>
              <Typography variant="body1" sx={{ fontSize: '15px', paddingTop: '10px', paddingBottom: '10px', display: 'flex', flexDirection: 'row' }}>
                <NoFoodIcon sx={{ padding: '0 10px' }} />
                {card.detail3}
              </Typography>
            </CardContent>

            <CardActions sx={{ width: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', borderTop: '1px solid #a4a4a6' }}>
              <Button size="small" sx={{ color: '#2CCE6C', fontSize: '12px', width: '65%', justifyContent: 'flex-start', paddingLeft: '20px' }}>
                Know More
              </Button>
              <Button variant="outlined" sx={{ color: '#2CCE6C', fontSize: '12px' }} size="small">
                Add to Cart
              </Button>
            </CardActions>
          </Card>
      ...
      <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '10px', paddingTop: '20px' }}>
        <Button variant="outlined" sx={{ color: '#2CCE6C', textTransform: 'capitalize' }}>
          Create Your Package
        </Button>
        <Button variant="outlined" sx={{ color: '#2CCE6C', textTransform: 'capitalize' }}>
